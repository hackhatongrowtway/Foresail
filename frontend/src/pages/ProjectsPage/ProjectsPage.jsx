...
function ProjectsPage({ user, theme, onToggleTheme, onNavigate, onLogout }) {
  ...
  const handleDelete = useCallback(async (project) => {
    if (!window.confirm(`Excluir o projeto "${project.name}"? Esta ação não pode ser desfeita.`)) return;
          ...
          <div className="projects-table-card">
            ...
            <div className="projects-toolbar">
              ...
              <div className="projects-toolbar-right">
                ...
                <button className="projects-btn-new" onClick={() => window.location.href = '/auth_flow.html'}>
                  ...
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={COLUMNS.length} className="projects-td--empty">
                        <EmptyState
                          ...
                          action={!search ? { label: '+ Novo projeto', onClick: () => window.location.href = '/auth_flow.html' } : null}
                        />
                      </td>
                    </tr>
                  ) : (
                    paginated.map((project, i) => {
                      ...
                      return (
                        <tr
                          key={project.id}
                          className={`projects-tr ${openMenu === project.id ? 'projects-tr--active' : ''}`}
                          style={{ animationDelay: `${i * 30}ms` }}
                          onClick={() => window.location.href = '/foresail-dashboard-v7.html'}
                          tabIndex={0}
                          onKeyDown={e => e.key === 'Enter' && (window.location.href = '/foresail-dashboard-v7.html')}
                        >
                          {/* Project name */}
                                ...
                                <>
                                  ...
                                  <div className="proj-menu-dropdown" role="menu">
                                    <button
                                      ...
                                      onClick={() => { window.location.href = '/foresail-dashboard-v7.html'; setOpenMenu(null); }}
                                    >
                                      Ver detalhes
                                    </button>
                                    <div className="proj-menu-divider" />
                                    <button
                                      className="proj-menu-item proj-menu-item--danger"
